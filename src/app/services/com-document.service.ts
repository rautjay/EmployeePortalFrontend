...
export class ComDocumentService {
  ...
  upload(file: File,id:any) : Observable<HttpEvent<any>> {
    const formData:any = new FormData();
       ...
       const req = new HttpRequest('POST', `${environment.baseUrl}/docs/upload/${id}`, formData,{
         reportProgress: true,
         responseType: 'json',
    ...
    uploadFileToIntern(file: File,id:any) : Observable<HttpEvent<any>> {
      const formData:any = new FormData();
         ...
         const req = new HttpRequest('POST', `${environment.baseUrl}/docs/upload/intern/${id}`, formData,{
           reportProgress: true,
           responseType: 'json',
